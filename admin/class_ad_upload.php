...
<body>
    ...
    <ul class="gnb">
      ...
      <li>
        ...
        <ul class="sub_menu">
          ...
          <li><a href="class_ad_upload.php" title="클래스등록" class="now_link">- 클래스등록</a></li>
  ...
  <p class="branch">홈 > 클래스관리 > 클래스등록</p>
  ...
  <main>
    ...
    <section class="class_ad_upload">
      ...
      <form action="./php/class_ad_update.php" name="class_ad_upload" method="post" id="class_ad_upload"
        ...
        <div class="class_ad_upload_cate">
          <select name="cl_category" id="class_ad_upload_select_cl" class="class_ad_upload_select_cl">
            ...
            <option value="보컬클래스">보컬클래스</option>
            <option value="힙합클래스">힙합클래스</option>
            <option value="뮤지컬/재즈/클래식클래스">뮤지컬/재즈/클래식클래스</option>
            <option value="프로듀싱클래스">프로듀싱클래스</option>
            <option value="음향관리/엔지니어링클래스">음향관리/엔지니어링클래스</option>
          </select>
        ...
        <div class="class_ad_upload_cl_name">
          <input type="text" name="cl_title" id="cl_title" placeholder="클래스명을 입력하세요.">
        </div>
        ...
        <div class="class_ad_upload_flexbox">
          ...
          <div class="class_ad_upload_right_box">
            ...
            <p>
              ...
              <input type="date" id="cl_start" name="cl_start">
            </p>
            <span class="class_ad_upload_conn">~</span>
            <!-- 종료일 -->
            <p>
              <label for="cl_end">종료일</label>
              <input type="date" id="cl_end" name="cl_end">
            </p>
          </div>
        ...
        <div class="class_ad_update_cl_thum">
          <!-- 클래스 영상 -->
          <div>
            <span>타이틀영상<img src="./images/file_upload_admin.svg" alt="비디오"></span>
            <input type="file" name="cl_video" id="cl_video" accept="video/*">
            <div id="class_ad_update_video_box"></div>
          ...
          <div class="thum_margin_left">
            ...
            <div id="class_ad_update_thum_box"></div>
        ...
        <div class="class_ad_update_cl_detailbox">
          ...
          <input type="file" name="cl_desc_image" id="cl_desc_image"
            accept="image/gif, image/jpg, image/jpeg, image/png">
          <div id="class_ad_update_detail_box"></div>
          <label for="cl_desc_image">등록</label>
        </div>

        <!-- 클래스 소개글 박스 -->
        <div class="class_ad_update_cl_desc">
          <textarea name="cl_desc" id="cl_desc" cols="30" rows="10" placeholder="클래스 소개를 입력하세요."></textarea>
        </div>
        ...
        <div class="class_ad_chapter_wrap">
          ...
          <ul class="class_ad_chapter_list">
            <li>
              <h4>챕터1</h4>
              <label for="cc_title_1" class="blind">챕터 제목</label>
              <input type="text" name="cc_title[]" id="cc_title_1" placeholder="챕터1 제목을 입력해 주세요." maxlength="50">

              <div class="class_ad_chapter_videobox">
                <span>챕터1 영상<img src="./images/file_upload_admin.svg" alt="비디오"></span>
                <div class="cc_video_1_box"></div>
                <label for="cc_video_1">등록</label>
                <input type="file" name="cc_video[]" id="cc_video_1" accept="video/*">
              </div>
              <label for="cc_desc_1" class="blind">챕터 설명</label>
              <textarea name="cc_desc[]" id="cc_desc_1" cols="30" rows="10" placeholder="챕터 설명을 입력해 주세요."></textarea>
            </li>
          </ul>
        </div>
        ...
        <div class="class_ad_update_cl_btn">
          <input type="submit" id="class_ad_update_cl_btn" value="등록">
  ...
  <script>
    ...
    $('#class_ad_upload').submit(function () {
      // alert($('#cl_desc').val());
      result = true;
      if (document.getElementById('class_ad_upload_select_cl').value.length < 1) {
      ...
      if (!($('#cl_video').get(0).files.length)) {
        ...
        $('#cl_video').focus();
        result = false;
      } else if ($('#cl_video').get(0).files[0].size > (10 * 1024 * 1024)) {
