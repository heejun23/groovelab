  ...
  <main>
    ...
    <nav id="h_box">
      <ul id="h_list">
        ...
        <li><a href="cl_producing.php" title="프로듀싱">프로듀싱</a></li>
        <li><a href="cl_lyric.php" title="작사/작곡">작사/작곡</a></li>
        <li><a href="cl_engineering.php" title="음향관리/엔지니어링" class="h_on">음향관리/엔지니어링</a></li>
      </ul>
    </nav>
...
ORDER BY cl_start DESC";
    ...
    <!-- <a href="class_more.php" title="더보기" class="more_btn">더보기 <img src="./images/arrow_down_white.svg" alt=""></a> -->
    ...
    <div class="pagination">
      ...
      if ($start_page >= $page_list_size) {
        ...
        echo "<a href=\"cl_engineering.php?no=$prev_list\"><img src='./images/prev_admin.svg'></a>";
      }
      ...
      for ($i = $start_page; $i <= $end_page; $i++) {
        ...
        if ($no != $page) {
          echo "<a href=\"cl_engineering.php?no=$page\">" . $page_num . "</a>";
        } else {
      ...
      if ($total_page > $end_page) {
        ...
        echo "<a href=\"cl_engineering.php?no=$next_list\"><img src='./images/next_admin.svg'></a>";
      }
