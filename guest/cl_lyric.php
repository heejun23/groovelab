  ...
  <main>
    ...
    <nav id="h_box">
      <ul id="h_list">
        ...
        <li><a href="cl_lyric.php" title="작사/작곡" class="h_on">작사/작곡</a></li>
...
ORDER BY cl_start DESC";
    ...
    <div class="pagination">
      ...
      if ($start_page >= $page_list_size) {
        ...
        echo "<a href=\"cl_lyric.php?no=$prev_list\"><img src='./images/prev_admin.svg'></a>";
      }
      ...
      for ($i = $start_page; $i <= $end_page; $i++) {
        ...
        if ($no != $page) {
          echo "<a href=\"cl_lyric.php?no=$page\">" . $page_num . "</a>";
        } else {
      ...
      if ($total_page > $end_page) {
        ...
        echo "<a href=\"cl_lyric.php?no=$next_list\"><img src='./images/next_admin.svg'></a>";
      }
