...
$query = "SELECT qna_no FROM gl_qna q WHERE cl_no='$cl_no' AND qna_parent_no IS NULL AND NOT EXISTS (
  SELECT 1
  FROM gl_qna a
  WHERE a.qna_parent_no = q.qna_no
) ORDER BY qna_no DESC LIMIT $no,1";
...
$query = "SELECT * from gl_qna q where q.qna_no<='$start_no' AND cl_no ='$cl_no' AND qna_parent_no IS NULL AND NOT EXISTS (
  SELECT 1
  FROM gl_qna a
  WHERE a.qna_parent_no = q.qna_no
)";
...
$sql = "SELECT count(*) from gl_qna q where cl_no ='$cl_no' AND qna_parent_no IS NULL AND NOT EXISTS (
  SELECT 1
  FROM gl_qna a
  WHERE a.qna_parent_no = q.qna_no
)";
  ...
  <main>
    <section class="qna">
      ...
      <div class="qna_ajax_tab">
        ...
        <a href="./qna_wait.php?cl_no=<?= $cl_no ?>" class="qna_tab_on">답변대기</a>
      ...
      <div class="qna_table_wrap">
        ...
        <div class="pagination">
          ...
          if ($start_page >= $page_list_size) {
            ...
            echo "<a href=\"qna_wait.php?no=$prev_list&cl_no=$cl_no\"><img src='./images/prev_admin.svg'></a>";
          }
          ...
          for ($i = $start_page; $i <= $end_page; $i++) {
            ...
            if ($no != $page) {
              echo "<a href=\"qna_wait.php?no=$page&cl_no=$cl_no\">" . $page_num . "</a>";
            } else {
          ...
          if ($total_page > $end_page) {
            ...
            echo "<a href=\"qna.php?no=$next_list&cl_no=$cl_no\"><img src='./images/next_admin.svg'></a>";
          }
