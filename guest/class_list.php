...
<?php include('./header_m.php')?>
  ...
  <main>
    ...
    <nav id="h_box">
      <ul id="h_list">
        <li><a href="class_list.php" title="전체" class="h_on">전체</a></li>
    ...
    <section id="class_info">
      ...
      <div class="pagination">
        ...
        if ($start_page >= $page_list_size) {
          ...
          echo "<a href=\"class_list.php?no=$prev_list\"><img src='./images/prev_admin.svg'></a>";
        }
        ...
        for ($i = $start_page; $i <= $end_page; $i++) {
          ...
          if ($no != $page) {
            echo "<a href=\"class_list.php?no=$page\">" . $page_num . "</a>";
          } else {
        ...
        if ($total_page > $end_page) {
          ...
          echo "<a href=\"class_list.php?no=$next_list\"><img src='./images/next_admin.svg'></a>";
        }
