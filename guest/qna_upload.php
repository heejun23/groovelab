...
<body>
  ...
  <main>
    <section class="qna_upload">
      ...
      <!-- qna 질문 제목 -->
      <form action="./php/qna_update.php?cl_no=<?= $cl_no ?>" name="qna_upload" method="post" id="qna_upload" onsubmit="return formCheck();" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="qna_upload_title_box">
          <label for="qna_title">제목</label>
          <input type="text" name="qna_title" id="qna_title" placeholder="제목을 입력하세요." required>
        ...
        <div class="qna_upload_txt_box">
          <textarea name="qna_content" id="qna_content" cols="30" rows="10" placeholder="질문의 내용을 작성해 주세요!" required></textarea>
        ...
        <div class="qna_upload_btn_box">
          ...
          <input type="submit" name="qna_upload_btn" id="qna_upload_btn" value="질문등록">
        </div>
      </form>
    </section>
  </main>
